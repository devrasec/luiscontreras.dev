  ...
  return (
    <Container as="main" role="main">
      ...
      <ul>
        ...
        <li>
          <Link to="https://rectangleapp.com/">Rectangle</Link>. Useful app that allows you to move
          and resize windows in macOS using keyboard shortcuts.
        </li>
        <li>
          <Link to="https://www.skype.com/en/">Skype</Link>
        </li>
        <li>
          <Link to="https://www.sourcetreeapp.com/">Sourcetree</Link>. I use it when I'm too lazy to
          use the terminal for Git commands.
        </li>
        <li>
